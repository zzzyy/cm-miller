...
(function ($) {
    ...
    $.fn.millerColumn = function (options) {
        ...
        if ("addCol" == args[0]) {
            ...
            if (null != listParentAddedItem) {
                ...
                if (!parentAlreadyWithChildren) {
                    listParentAddedItem.append($("<i/>").addClass("material-icons").text("navigate_next1").addClass("has-children"));
                }
            }
        ...
        function buildColListItem(item, readOnly) {
            ...
            if (item.hasChildren)
                millerColListItem.append($("<i/>").addClass("material-icons").addClass("has-children"));
